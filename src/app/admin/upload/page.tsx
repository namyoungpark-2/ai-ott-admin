  ...
  return (
    <div className="max-w-xl space-y-4">
      <div>
        ...
        <div className="mt-1 text-sm text-[rgb(var(--fg-secondary))]">Upload a video file and optionally auto-transcode.</div>
      </div>
      ...
      <Card>
        <CardContent className="pt-6">
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            {mode === "EPISODE" && (
              <Card>
                <CardHeader>
                  ...
                  <div className="text-xs text-[rgb(var(--fg-secondary))]">Provide an existing series ID or a new series title.</div>
                </CardHeader>
                <CardContent className="space-y-3 pt-0">
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-[rgb(var(--fg-secondary))]">Series ID (existing)</label>
                    <Input
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-[rgb(var(--fg-secondary))]">Series Title (new)</label>
                    <Input
            ...
            {/* File */}
            <div className="space-y-1">
              <label className="text-xs font-semibold text-[rgb(var(--fg-secondary))]">Video File *</label>
              <input
                type="file"
                accept="video/*"
