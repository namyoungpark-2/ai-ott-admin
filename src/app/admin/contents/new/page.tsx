  ...
  return (
    <div className="max-w-xl space-y-4">
      <div>
        ...
        <div className="mt-1 text-sm text-zinc-500">Create a content record (without uploading a video).</div>
      </div>
            ...
            {mode === "EPISODE" && (
              <Card>
                <CardHeader>
                  ...
                  <div className="text-xs text-zinc-400">Provide an existing series ID, or a new series title to create one.</div>
                </CardHeader>
                <CardContent className="space-y-3 pt-0">
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-zinc-600">Existing Series ID (UUID)</label>
                    <Input
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-zinc-600">New Series Title</label>
                    <Input
